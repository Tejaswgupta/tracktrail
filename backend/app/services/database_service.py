...
class DatabaseService:
    ...
    async def get_entity_transactions(
        ...
        try:
            ...
            logger.info(f"Successfully retrieved {len(df) if hasattr(df, '__len__') else 0} transactions")
            return df
        ...
        try:
            ...
            metadata.update({
                "validation_status": {
                    ...
                    "success_rate": (metadata.get("total_count", 0) / len(entity_ids)) * 100
                },
    ...
    async def get_transaction_count(
        ...
        try:
            ...
            if 'entity_id' in df.columns:
                ...
                total_count = len(df)
                counts = {entity_id: total_count // len(entity_ids) for entity_id in entity_ids}

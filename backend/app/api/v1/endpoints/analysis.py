...
from app.core.exceptions import ValidationError, EntityNotFoundError, AnalysisError, DatabaseError
    ...
    **Multiple Entities (Network Cycle Detection):**
    ...
    try:
        ...
        if entity_count == 1:
            ...
            # Network cycle detection results
            ...
            if cycles_found > 0:
                message = f"Network cycle detection completed successfully. Found {cycles_found} cycles, {high_confidence_cycles} high-confidence."
            else:

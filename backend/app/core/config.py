...
class Settings:
    ...
    def __init__(self):
        ...
        # Database settings
        self.supabase_url = os.getenv("SUPABASE_URL", "https://bouniuqsbzluhnqrgses.supabase.co")
        self.supabase_key = os.getenv("SUPABASE_ANON_KEY", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJvdW5pdXFzYnpsdWhucXJnc2VzIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU0MDM5MDEsImV4cCI6MjA3MDk3OTkwMX0.UM0a1ibnB-3CWmSqMaIhLypa3vlB7smp6ts0xhWGtMY")

...
-- 9. Workspace regex patterns for organizational sharing
CREATE TABLE workspace_regex_patterns (
...
CREATE INDEX idx_workspace_regex_workspace ON workspace_regex_patterns (workspace_id);
